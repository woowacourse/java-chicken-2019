...
public class OutputView {
    ...
    private static final String BOTTOM_LINE_WITH_MENU = "└ $ ┘";
    ...
    private static final String NO_MENU_ERROR = "결제 할 메뉴가 존재하지 않습니다.";
    ...
    public static void printTotalMoney(double totalMoney) {
        System.out.println(NEW_LINE+ FINAL_MONEY_TO_PAY);
    ...
    public static void printNoMenu() {
        System.out.println(NO_MENU_ERROR);
    }
}
