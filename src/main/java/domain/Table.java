...
public class Table {
    ...
    public String order(int newMenuCategory, int newMenuCount){
        ...
        if(isNotOverNewCountNumber(newMenuCount)) {
            inputNewOrder(newMenuCategory, newMenuCount);
            return "새로운 주문이 완료되었습니다.";
        }
        return "수량을 초과하여 주문할 수 없습니다.";
    }
    ...
    public boolean isNotOverNewCountNumber(int newInputMenuCount) {
        return newInputMenuCount <= MAX_ORDER_COUNT;
    }
