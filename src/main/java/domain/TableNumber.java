...
public class TableNumber {
    ...
    public TableNumber(String inputString, boolean isUnpaid) {
        int tableNumber;
        try {
            tableNumber =  Integer.parseInt(inputString);
        } catch (NumberFormatException e) {
        ...
        if (TableRepository.isNotUnpaidTableNumber(tableNumber)) {
            throw new IllegalArgumentException("※ 미결제 테이블 번호만 입력 가능합니다.");
        }
        this.tableNumber = tableNumber;
    }
