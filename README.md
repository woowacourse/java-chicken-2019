...
3. (Business - **구현완료**) 사용자가 입력한 기능의 숫자에 해당 기능을 불러오는 기능.

4. (UI - **구현완료**) 사용자가 등록할 메뉴를 입력 받아오는 기능.

5. (UI - **구현완료**) 등록할 메뉴의 수량을 입력 받아오는 기능.

6. (Business) 메뉴의 주문 가능한 최대 수량을 99개로 제한하는 기능.

7. (UI) 결제가 진행되지 않은 테이블은 별도로 표시하는 기능.

8. (UI) 주문한 내역을 출력하는 기능.

9. (UI) 결제 방법을 입력받는 기능.

10. (Business) 현금 결제의 경우 5%의 할인을 진행하는 기능.

11. (Business) 주문한 치킨의 수량의 합이 10개가 넘는 경우에 10,000원씩 추가로 할인하는 기능.

12. (UI) 최종 결제 금액을 출력하는 기능.

13. (UI) 주문 혹은 결제가 불가능한 경우, 그 이유를 보여 주고, 다시 주문 혹은 결제가 가능하도록 하는 기능.
